...
# This script was made adapting publicly published code from several sources online. 
# Please check the file resources.txt for a complete list of resoures used.
